      ...
      <div className="p-4">
        <div className="flex flex-col  p-5 space-y-3">
          ...
          <div className="space-y-6">
            <p className="text-sm">
              When our tomatoes grow to size, they are sent to our on site shop.
              We will have completed our job with care.
            </p>
            <p className="text-xs">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iusto
              accusantium rerum voluptas neque aut libero tempora id molestias
              non, at natus magnam impedit dolorem sequi est nemo delectus earum
              similique?
            </p>
            <p className="text-xs">
