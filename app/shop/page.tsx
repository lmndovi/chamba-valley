...
const ShopPage: React.FC = () => {
  return (
    <div className="container flex flex-col space-y-8 mx-auto p-4 mt-20 mb-36 bg-black-board bg-cover  pt-28 rounded-xl border-8 border-solid border-[#CAA472] w-[360px] md:w-[700px]">
